...
const MakePerfume = ({ formula, targetVolume, existingBatch, onBack, onSave }) => {
  ...
  const handleAddAmount = (ingredientId, amountStr) => {
    ...
    // Check if this new pour exceeds the current target for this ingredient
    ...
    // Apply auto-scale if the new pour forced the target floor up
          ...
          <div>
            ...
            <div className="flex flex-wrap items-center gap-2 mt-1">
              ...
              <input
                ...
                className="w-24 px-2 py-1 text-sm font-semibold border border-indigo-300 dark:border-indigo-600 rounded bg-indigo-50 dark:bg-indigo-900/30 text-indigo-700 dark:text-indigo-300 focus:ring-2 focus:ring-indigo-500 outline-none transition-colors"
              />
          ...
          <table className="w-full text-left border-collapse min-w-[600px]">
            <thead>
              <tr className="bg-gray-50 dark:bg-gray-800/50 border-b border-gray-200 dark:border-gray-700">
                ...
                <th className="py-4 px-6 font-semibold text-gray-600 dark:text-gray-300 text-sm">Target</th>
